...
|-----------|---------|--------|
| CH₄ Gas | 1,243 ppm | 🟢 NORMAL |
| CO Level | 892 ppm | 🟢 NORMAL |
| Temperature | 38.5 °C | 🟡 CAUTION |
| Water Level | 45 cm | 🟢 NORMAL |
...
This project was built for **Hackathon 2025** by Team Error 404. Open for educational and non-commercial use.
